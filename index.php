    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                            ...
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        ...
                                        $count_comment = mysqli_num_rows($select_all_comments);
                            ...
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        ...
                                        $count_user = mysqli_num_rows($select_all_users);
                ...
                $count_published_post = mysqli_num_rows($select_all_published_posts);
                ...
                $count_draft_post = mysqli_num_rows($select_all_draft_posts);
                ...
                $count_unapproved_comments = mysqli_num_rows($unapproved_comment);
                    ...
                    <script type="text/javascript">
                        ...
                        function drawChart() {
                            var data = google.visualization.arrayToDataTable([
                                ...
                                $element_count = [$count_post, $count_published_post, $count_draft_post, $count_comment, $count_unapproved_comments, $count_user, $count_subscriber, $count_category];
